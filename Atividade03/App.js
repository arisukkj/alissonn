...
import { View, Text, Image, Platform, Button, Appearance, StyleSheet, 
  FlatList, NavigationContainer, Linking} from 'react-native';
  ...
  <Text style={{fontSize: 18, color: 'black', textAlign:'center'}}>
    {this.state.nome}
        ...
        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingLeft: 10}}>
          ...
          onPress={
            () => {Linking.openURL('https://www.codecademy.com/')}
          }>CodeCademy</Text>
        </View>
        ...
        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingLeft: 10}}>
          ...
          <Text style={styles.hyperlinkStyle}
          onPress={
            () => {Linking.openURL('https://ebaconline.com.br/')}
          }>EBAC</Text>
        </View>
        ...
        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingLeft: 10}}>
          ...
          <Text style={styles.hyperlinkStyle}
          onPress={
            () => {Linking.openURL('https://www.udemy.com/pt/?srsltid=AfmBOopIHGTcv-l5m8InRxEhs9vA0mzFBQwfjiOEraUeS2oiJLveyjgO')}
          }>Udemy</Text>
        </View>
        ...
        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingLeft: 10}}>
          ...
          <Text style={styles.hyperlinkStyle}
          onPress={
            () => {Linking.openURL('https://www.iesb.br/')}
          }>IESB</Text>
        </View>
        ...
        <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', paddingLeft: 10}}>
          ...
          <Text style={styles.hyperlinkStyle}
          onPress={
            () => {Linking.openURL('https://www.unb.br/')}
          }>UNB</Text>
        </View>
